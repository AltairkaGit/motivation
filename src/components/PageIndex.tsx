...
const Interface = ({data}: {data: State | undefined}) => {
    ...
    return (
        <motion.div className="flex flex-col gap-5 px-5 pt-6 pb-[38vh] xl:pb-[100vh] xl:min-h-[150vh] xl:pt-10 xl:px-12 2xl:pt-12 2xl:px-20 3xl:px-32 3xl:pt-24 items-center ">
